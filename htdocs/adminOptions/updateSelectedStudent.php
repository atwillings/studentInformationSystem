...
<form action="">
	...
	Student Password <input type="text" name="studentPass" value="<?php echo $_GET['studentPass'] ?>"/>   			<br><br>
	Student First Name <input type="text" name="studentFirstName" value="<?php echo $_GET['studentFirstName'] ?>"/>    <br><br>
	Student Last Name <input type="text" name="studentLastName" value="<?php echo $_GET['studentLastName'] ?>"/>      <br><br>
